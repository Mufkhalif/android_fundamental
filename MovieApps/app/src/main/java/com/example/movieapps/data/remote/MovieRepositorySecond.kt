...
class MovieRepositorySecond private constructor(private val remoteDataSource: RemoteDataSource) :
    MovieDataSource {
    companion object {
        private const val TAG = "MovieRepositorySecond"

        @Volatile
        private var instance: MovieRepositorySecond? = null

        fun getInstance(remoteDataSource: RemoteDataSource): MovieRepositorySecond =
            instance ?: synchronized(this) {
                MovieRepositorySecond(remoteDataSource).apply { instance = this }
            }
    }
