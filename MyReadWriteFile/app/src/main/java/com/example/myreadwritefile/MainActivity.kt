    ...
    private fun saveFile() {
        when {
            binding.editTitle.text.toString()
                .isEmpty() -> showMessage("Title Harus diisi terlebih dahulu")
            binding.editFile.text.toString()
                .isEmpty() -> showMessage("Kontent Harus diisi terlebih dahulu")
            else -> {
                ...
                showMessage("Saving " + fileModel.filename + " File")
            }
        }
    }
